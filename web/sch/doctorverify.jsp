...
//                   System.out.println(item.getContentType());
                ...
                {
                  String send=("<h1>Your Registration Details:</h1><br><br>Your Name:"+fn+""+ln+" <br> Your ID Number:"+id+"<br> Your USERNAME:"+un+" <br> Your Mobile Number:"+phone+"<br>");
                    msg="sucess";
